...
public class PruebaMotor {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/* Le pedimos al usuario que nos informe el tipo de motor */
		sX555.dimeTipoMotor(0);
		
		/* A través del condicional múltiple indicamos el tipo de motor en base al tipo de motor previamente ingresado */
		
		switch(sX555.getTipoMotor()) {
